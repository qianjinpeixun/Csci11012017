		...
		try {
			...
			while (true) {
				...
				if (isFirstReach == false) {
					...
					int nextX=firstRobot.getNextX(newSteps);
					int nextY=firstRobot.getNextY(newSteps);
				...
				if (isSecondReach == false) {
					...
					int nextX=secondRobot.getNextX(newSteps);
					int nextY=secondRobot.getNextY(newSteps);
